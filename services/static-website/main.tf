...
module "static_website" {
  source = "git::git@github.com:gruntwork-io/package-static-assets.git//modules/s3-static-website?ref=v0.3.2"
...
module "cloudfront" {
  source = "git::git@github.com:gruntwork-io/package-static-assets.git//modules/s3-cloudfront?ref=v0.3.2"
  ...
  hosted_zone_id         = "${element(concat(data.terraform_remote_state.route53_public.*.primary_domain_hosted_zone_id, list("")), 0)}"
